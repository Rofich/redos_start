...
` dnf install php php-common php-fpm php-cli php-mysql php-json php-gmp php-imap php-gd php-ldap php-odbc php-opcache php-pear php-xml php-xmlrpc php-mbstring php-snmp php-soap php-zip php-curl php-imagick php-intl `
<hr>
